...
int num_of_lines_paragraph = 4 ;
int num_of_paragraph = 4 ;
...
//generate a radom paragraph from the random_text_line function
...
//generate a random chapter from the generate_random_paragraph function
